...
public class AnalysisHelper {
    ...
    public void getAverageLikesPerComments() {
        ...
        System.out.println("Ans1. - Average number of likes per comments: " + likeNumber / commentNumber);
    ...
    public void getMaxLikeCommentPost() {
        ...
        System.out.println("Ans2. - post with most likes per comment: " + data.getPosts().get(postId).getPostId());
    ...
    public void getPostWithMostComments(){
        ...
        System.out.println("Ans3. - post with most comments: " + postWithMostComments.getPostId());
    ...
    public void getPassiveUsers () {
        ...
        System. out.println ("Ans4. - The following users have the least posts: ") ;
        for (int i = 0; i < 5; i++) {
    ...
    public void getPassiveCommentUsers () {
        ...
        System.out.println("Ans5. - The following users have the least comments: ");
        for(int i = 0; i < 5; i++) {
    ...
    public void getPassiveAndActiveOverallUsers () {
        ...
        System.out.println("Ans6. - The following users have overall been passive: ");
        for (int i = 0; i < 5; i++) {
            System.out.println (users.get (i) + ", - Overall count: "+ overallNumbers.get(users.get(i).getId()));
        }
        //Collections.sort (users, new UserMapComparator(overallNumbers) );
        System. out.println ("Ans7. - The following users have overall been active: ");
