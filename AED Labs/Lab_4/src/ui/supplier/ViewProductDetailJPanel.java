...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    public ViewProductDetailJPanel(JPanel workArea, Product product) {
        ...
        if (product.getProductImage() != null) {
            ...
            imgProduct.setText("No Product Image");
        }
...
//        saveFeatures();
        ...
        String featureValue = JOptionPane.showInputDialog(this, "Enter Feature Value:");

        if (featureName != null && featureValue != null) {
            product.addNewFeature(featureName, featureValue);
            refreshTable();
            saveFeatures();
            // Refresh the UI to show the updated features
        } else {
            JOptionPane.showMessageDialog(this, "Feature Name and Value cannot be empty.", "Warning", JOptionPane.WARNING_MESSAGE);
        }
